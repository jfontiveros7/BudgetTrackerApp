                    ...
                    <div class="panel rounded-[28px] p-6 md:p-8">
                        <?php if ($checkoutDestination !== "" && !$canceled): ?>
                            ...
                            <div class="rounded-3xl border border-black/6 bg-[#F9F8F6] p-5">
                                ...
                                <div class="mt-4 inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-2 text-xs text-black/62">
                                    <span class="mono text-[10px] uppercase tracking-[0.18em] text-[#0052FF]">Billing name</span>
                                    <span><strong>Konticode Budget App</strong> on Stripe</span>
                                </div>
                            ...
                            <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                                <a href="<?php echo htmlspecialchars($checkoutDestination); ?>" class="cta-primary px-5 py-3 text-sm">Continue to Secure Stripe Checkout</a>
